...
HX_DEFINE_STACK_FRAME(_hx_pos_31bbc4696cde81a4_46_new,"IntIterator","new",0x5692054f,"IntIterator.new","C:\\HaxeToolkit\\haxe\\std/IntIterator.hx",46,0xe7315e9a)
HX_LOCAL_STACK_FRAME(_hx_pos_31bbc4696cde81a4_55_hasNext,"IntIterator","hasNext",0xd8737ddc,"IntIterator.hasNext","C:\\HaxeToolkit\\haxe\\std/IntIterator.hx",55,0xe7315e9a)
HX_LOCAL_STACK_FRAME(_hx_pos_31bbc4696cde81a4_64_next,"IntIterator","next",0x6932a124,"IntIterator.next","C:\\HaxeToolkit\\haxe\\std/IntIterator.hx",64,0xe7315e9a)

void IntIterator_obj::__construct(int min,int max){
            	HX_STACKFRAME(&_hx_pos_31bbc4696cde81a4_46_new)
...
bool IntIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_31bbc4696cde81a4_55_hasNext)
...
int IntIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_31bbc4696cde81a4_64_next)
