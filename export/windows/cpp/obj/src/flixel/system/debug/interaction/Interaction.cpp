...
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_380_saveSystemCursorInfo,"flixel.system.debug.interaction.Interaction","saveSystemCursorInfo",0x622efa70,"flixel.system.debug.interaction.Interaction.saveSystemCursorInfo","flixel/system/debug/interaction/Interaction.hx",380,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_388_restoreSystemCursor,"flixel.system.debug.interaction.Interaction","restoreSystemCursor",0x6747acb3,"flixel.system.debug.interaction.Interaction.restoreSystemCursor","flixel/system/debug/interaction/Interaction.hx",388,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_397_setActiveTool,"flixel.system.debug.interaction.Interaction","setActiveTool",0x92d80fa0,"flixel.system.debug.interaction.Interaction.setActiveTool","flixel/system/debug/interaction/Interaction.hx",397,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_427_setSystemCursorVisibility,"flixel.system.debug.interaction.Interaction","setSystemCursorVisibility",0x3bad5fb9,"flixel.system.debug.interaction.Interaction.setSystemCursorVisibility","flixel/system/debug/interaction/Interaction.hx",427,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_435_setToolsCursorVisibility,"flixel.system.debug.interaction.Interaction","setToolsCursorVisibility",0x9dd4e861,"flixel.system.debug.interaction.Interaction.setToolsCursorVisibility","flixel/system/debug/interaction/Interaction.hx",435,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_453_clearSelection,"flixel.system.debug.interaction.Interaction","clearSelection",0x1e241bdf,"flixel.system.debug.interaction.Interaction.clearSelection","flixel/system/debug/interaction/Interaction.hx",453,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_458_keyPressed,"flixel.system.debug.interaction.Interaction","keyPressed",0xc6e951a3,"flixel.system.debug.interaction.Interaction.keyPressed","flixel/system/debug/interaction/Interaction.hx",458,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_462_keyJustPressed,"flixel.system.debug.interaction.Interaction","keyJustPressed",0x9fbba157,"flixel.system.debug.interaction.Interaction.keyJustPressed","flixel/system/debug/interaction/Interaction.hx",462,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_468_findItemsWithinState,"flixel.system.debug.interaction.Interaction","findItemsWithinState",0x412153bf,"flixel.system.debug.interaction.Interaction.findItemsWithinState","flixel/system/debug/interaction/Interaction.hx",468,0x4548a912)
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_486_findItemsWithinArea,"flixel.system.debug.interaction.Interaction","findItemsWithinArea",0xfd927d9f,"flixel.system.debug.interaction.Interaction.findItemsWithinArea","flixel/system/debug/interaction/Interaction.hx",486,0x4548a912)
namespace flixel{
...
HXLINE( 358)					 ::openfl::_legacy::display::DisplayObject sprite = this->_customCursor->getChildAt(i);
HXLINE( 359)					::String _hx_tmp1 = sprite->get_name();
HXDLIN( 359)					sprite->set_visible((_hx_tmp1 == this->activeTool->get_name()));
            				}
            			}
            			else {
...
void Interaction_obj::saveSystemCursorInfo(){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_380_saveSystemCursorInfo)
...
void Interaction_obj::restoreSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_388_restoreSystemCursor)
...
void Interaction_obj::setActiveTool( ::flixel::_hx_system::debug::interaction::tools::Tool value){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_397_setActiveTool)
HXLINE( 398)		if (hx::IsNotNull( this->activeTool )) {
HXLINE( 400)			this->activeTool->deactivate();
HXLINE( 401)			this->activeTool->button->set_toggled(true);
            		}
HXLINE( 404)		if (hx::IsEq( this->activeTool,value )) {
HXLINE( 405)			value = null();
            		}
HXLINE( 407)		this->activeTool = value;
HXLINE( 409)		if (hx::IsNotNull( this->activeTool )) {
...
void Interaction_obj::setSystemCursorVisibility(bool status){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_427_setSystemCursorVisibility)
...
void Interaction_obj::setToolsCursorVisibility(bool status){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_435_setToolsCursorVisibility)
...
HXDLIN( 447)			int _g = this->_customCursor->get_numChildren();
...
void Interaction_obj::clearSelection(){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_453_clearSelection)
HXDLIN( 453)		this->selectedItems->clear();
            	}
...
bool Interaction_obj::keyPressed(int key){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_458_keyPressed)
HXDLIN( 458)		return ( (bool)(this->_keysDown->get(key)) );
            	}
...
bool Interaction_obj::keyJustPressed(int key){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_462_keyJustPressed)
HXLINE( 463)		int value;
HXDLIN( 463)		if (hx::IsNull( this->_keysUp->get(key) )) {
HXLINE( 463)			value = (int)0;
            		}
            		else {
HXLINE( 463)			value = ( (int)(this->_keysUp->get(key)) );
            		}
...
void Interaction_obj::findItemsWithinState(::Array< ::Dynamic> items, ::flixel::FlxState state, ::flixel::math::FlxRect area){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_468_findItemsWithinState)
HXLINE( 469)		this->findItemsWithinArea(items,state->members,area);
HXLINE( 470)		if (hx::IsNotNull( state->subState )) {
...
void Interaction_obj::findItemsWithinArea(::Array< ::Dynamic> items,::Array< ::Dynamic> members, ::flixel::math::FlxRect area){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_486_findItemsWithinArea)
HXLINE( 488)		int i = members->length;
HXLINE( 489)		while(true){
HXLINE( 489)			i = (i - (int)1);
HXDLIN( 489)			if (!(((i + (int)1) > (int)0))) {
HXLINE( 489)				goto _hx_goto_33;
            			}
HXLINE( 491)			 ::flixel::FlxBasic member = members->__get(i).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 493)			bool _hx_tmp;
HXDLIN( 493)			bool _hx_tmp1;
HXDLIN( 493)			if (hx::IsNotNull( member )) {
HXLINE( 493)				_hx_tmp1 = !(member->visible);
            			}
            			else {
HXLINE( 493)				_hx_tmp1 = true;
            			}
HXDLIN( 493)			if (!(_hx_tmp1)) {
HXLINE( 493)				_hx_tmp = !(member->exists);
            			}
            			else {
...
HXLINE( 496)			 ::flixel::group::FlxTypedGroup group = ::flixel::group::FlxTypedGroup_obj::resolveGroup(member);
HXLINE( 497)			if (hx::IsNotNull( group )) {
HXLINE( 498)				this->findItemsWithinArea(items,group->members,area);
            			}
            			else {
HXLINE( 499)				bool _hx_tmp2;
HXDLIN( 499)				if (::Std_obj::is(member,hx::ClassOf< ::flixel::FlxSprite >())) {
HXLINE( 500)					 ::flixel::math::FlxRect Rect = hx::TCast<  ::flixel::FlxObject >::cast(member)->getHitbox(null());
HXDLIN( 500)					bool result;
HXDLIN( 500)					bool result1;
HXDLIN( 500)					bool result2;
HXDLIN( 500)					if (((Rect->x + Rect->width) > area->x)) {
HXLINE( 500)						Float Rect1 = Rect->x;
HXDLIN( 500)						result2 = (Rect1 < (area->x + area->width));
            					}
            					else {
HXLINE( 500)						result2 = false;
            					}
HXDLIN( 500)					if (result2) {
HXLINE( 500)						result1 = ((Rect->y + Rect->height) > area->y);
            					}
            					else {
HXLINE( 500)						result1 = false;
            					}
HXDLIN( 500)					if (result1) {
HXLINE( 500)						Float Rect2 = Rect->y;
HXDLIN( 500)						result = (Rect2 < (area->y + area->height));
            					}
            					else {
HXLINE( 500)						result = false;
            					}
HXDLIN( 500)					if (Rect->_weak) {
HXLINE( 500)						if (!(Rect->_inPool)) {
HXLINE( 500)							Rect->_inPool = true;
HXDLIN( 500)							Rect->_weak = false;
HXDLIN( 500)							::flixel::math::FlxRect_obj::_pool->putUnsafe(Rect);
            						}
            					}
HXLINE( 499)					_hx_tmp2 = result;
            				}
            				else {
