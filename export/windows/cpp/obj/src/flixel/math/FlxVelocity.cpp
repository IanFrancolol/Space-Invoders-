...
HXLINE(  29)			Float dx = (Source->x + Source->origin->x);
HXDLIN(  29)			Float dx1 = (dx - (Dest->x + Dest->origin->x));
HXDLIN(  29)			Float dy = (Source->y + Source->origin->y);
HXDLIN(  29)			Float dy1 = (dy - (Dest->y + Dest->origin->y));
HXDLIN(  29)			int d = ::Std_obj::_hx_int(::Math_obj::sqrt(((dx1 * dx1) + (dy1 * dy1))));
HXLINE(  32)			Speed = ::Std_obj::_hx_int(((Float)d / (Float)((Float)MaxTime / (Float)(int)1000)));
            		}
HXLINE(  35)		 ::flixel::math::FlxPoint Source1 = Source->velocity;
HXDLIN(  35)		Source1->set_x((::Math_obj::cos(a) * Speed));
HXLINE(  36)		 ::flixel::math::FlxPoint Source2 = Source->velocity;
HXDLIN(  36)		Source2->set_y((::Math_obj::sin(a) * Speed));
            	}
...
HXDLIN(  52)			 ::flixel::math::FlxPoint Source1 = Source->acceleration;
HXDLIN(  52)			Source1->set((cosA * Acceleration),(sinA * Acceleration));
HXDLIN(  52)			 ::flixel::math::FlxPoint Source2 = Source->maxVelocity;
HXDLIN(  52)			Float _hx_tmp = ::Math_obj::abs((cosA * MaxSpeed));
HXDLIN(  52)			Source2->set(_hx_tmp,::Math_obj::abs((sinA * MaxSpeed)));
            		}
            	}
...
HXLINE(  72)			Float dx = ((Source->x + Source->origin->x) - ::flixel::FlxG_obj::mouse->screenX);
HXDLIN(  72)			Float dy = ((Source->y + Source->origin->y) - ::flixel::FlxG_obj::mouse->screenY);
...
HXLINE(  78)		 ::flixel::math::FlxPoint Source1 = Source->velocity;
HXDLIN(  78)		Source1->set_x((::Math_obj::cos(a) * Speed));
HXLINE(  79)		 ::flixel::math::FlxPoint Source2 = Source->velocity;
HXDLIN(  79)		Source2->set_y((::Math_obj::sin(a) * Speed));
            	}
...
HXDLIN( 125)			 ::flixel::math::FlxPoint Source1 = Source->acceleration;
HXDLIN( 125)			Source1->set((cosA * Acceleration),(sinA * Acceleration));
HXDLIN( 125)			 ::flixel::math::FlxPoint Source2 = Source->maxVelocity;
HXDLIN( 125)			Float _hx_tmp = ::Math_obj::abs((cosA * MaxSpeed));
HXDLIN( 125)			Source2->set(_hx_tmp,::Math_obj::abs((sinA * MaxSpeed)));
            		}
            	}
...
HXLINE( 171)		 ::flixel::math::FlxPoint Source1 = Source->velocity;
HXDLIN( 171)		Source1->set_x((::Math_obj::cos(a) * Speed));
HXLINE( 172)		 ::flixel::math::FlxPoint Source2 = Source->velocity;
HXDLIN( 172)		Source2->set_y((::Math_obj::sin(a) * Speed));
...
HXDLIN( 191)			 ::flixel::math::FlxPoint Source1 = Source->acceleration;
HXDLIN( 191)			Source1->set((cosA * Acceleration),(sinA * Acceleration));
HXDLIN( 191)			 ::flixel::math::FlxPoint Source2 = Source->maxVelocity;
HXDLIN( 191)			Float _hx_tmp = ::Math_obj::abs((cosA * MaxSpeed));
HXDLIN( 191)			Source2->set(_hx_tmp,::Math_obj::abs((sinA * MaxSpeed)));
            		}
...
HXLINE( 205)		Float a = (Angle * ((Float)::Math_obj::PI / (Float)(int)180));
...
HXLINE( 287)		 ::flixel::math::FlxPoint source1 = source->acceleration;
HXDLIN( 287)		source1->set((cosA * acceleration),(sinA * acceleration));
HXLINE( 288)		 ::flixel::math::FlxPoint source2 = source->maxVelocity;
HXDLIN( 288)		Float _hx_tmp = ::Math_obj::abs((cosA * maxSpeed));
HXDLIN( 288)		source2->set(_hx_tmp,::Math_obj::abs((sinA * maxSpeed)));
            	}
