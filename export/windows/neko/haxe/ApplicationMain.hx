...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Theo leyenda", "spaceinvadersCODIGO", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "space invaders(CODIGO)";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "space invaders(CODIGO)", null, { width: 480, height: 432 });
