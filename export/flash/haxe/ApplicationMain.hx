...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/BalaEnemigo.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/enemigo4.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/estructuraDefensiva.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/images/marcianito-Loko.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/sounds/oopcion2ExlocionEnemigo.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/opcion1DisparoJugador.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/opcion1ExplocionEnemigo.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/opcion2DisparoJugador.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/opcion3DisparoJugador.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/opcionDisparoEnemigo.wav");
		types.push (lime.Assets.AssetType.SOUND);
