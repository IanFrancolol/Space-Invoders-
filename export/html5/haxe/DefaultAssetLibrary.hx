...
@:keep @:bind #if display private #end class __ASSET__assets_sounds_explocionmarcianitoloko_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_explosion_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_explosionjugador_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_laser_shoot2_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_oopcion2exlocionenemigo_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_opcion1disparojugador_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_opcion1explocionenemigo_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_opcion2disparojugador_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_opcion3disparojugador_wav extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_opciondisparoenemigo_wav extends null { }
